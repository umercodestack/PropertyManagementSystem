                                                    ...
                                                    <div class="row" id="inquiry_offer_card">
                                                        ...
                                                        <div class="col-md-6">
                                                            <button class="btn btn-primary btn-sm" id="special_offer"
                                                                data-id="" onclick="openSpecialOfferDiv(this)">Special
                                                                Offer</button>
                                                        </div>
...
<script>
        ...
        $.ajax({
            ...
            <span>
                <img src="{{ asset('assets/images/logo/vrbo.png') }}"
                    ...
                    let newMessage = `
                        <div class="nk-msg-item" id="nk-msg-item-${item.id}" data-msg-id="` + index + `" onclick="fetchThreadByID(` + item.id +
                        `, ` + title + `, ` + live_feed_event_id + ` , ` + itemName + `)">
  ...
  ${logoHtml} 
    ...
    function fetchThreadByID(thread_id, title, live_feed_event_id, itemName) {
        if (thread_id == null) {
            $('#cust_title').append("")
            $('#message_div').empty();
  ...
  ${item.sender === 'guest' ? itemName.slice(0, 1) : 'M'}
            ...
            <div class="date-time" style="text-align: ${checkUser ? 'end' : 'start'}; padding: 5px 3px; color: #8094ae;">` + formattedDate + `</div>
        </div>
    </div>`;
            ...
            <span>
                <img src="{{ asset('assets/images/logo/vrbo.png') }}"
                     ...
                     style="width:20px; max-width:20px; margin-top:7px" />
                        ...
                        let newMessage = `
                        <div class="nk-msg-item" id="nk-msg-item-${item.id}" data-msg-id="` + index + `" onclick="fetchThreadByID(` + item.id +
                            `, ` + title + `, ` + live_feed_event_id + ` , ` + item.name + `)">
                             <div style="display:flex; flex-direction:column;     align-items: center;">
                            <div class="nk-msg-media user-avatar">
                                <span>` + item.name.charAt(0) + `</span>
