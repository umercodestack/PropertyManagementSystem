...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Edit Host Rental Lease</h3>
        </div>
        <div class="nk-block-head-content">
...
<div class="card card-bordered">
    <div class="card-inner">
        <form method="POST" action="{{ route('host-rental-lease.update', $op->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="form-label">Host Rental Lease Date</label>
                        <input type="text" class="form-control" value="{{ $op->hostaboard->host_rental_lease ?? 'N/A' }}" disabled>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="will_extend" {{ old('status', $op->status) == 'will_extend' ? 'selected' : '' }}>Will Extend</option>
                            <option value="will_not_extend" {{ old('status', $op->status) == 'will_not_extend' ? 'selected' : '' }}>Will Not Extend</option>
                        </select>
                    </div>
                </div>
