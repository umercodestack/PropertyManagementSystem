                        ...
                        <div class="row gy-4">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select select2" name="user_id" id="user_id" data-placeholder="Select Host">
                                            ...
                                            @foreach($users as $items)
                                                <option value="{{$items->id}}" {{ $host_user_id == $items->id ? 'selected' : '' }}>{{$items->name}} {{$items->surname}}</option>
                                            @endforeach
                                        </select>
                                        @error('user_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select select2" name="min_stay_type" id="min_stay_type" data-placeholder="Select Minimum Stay Type">
