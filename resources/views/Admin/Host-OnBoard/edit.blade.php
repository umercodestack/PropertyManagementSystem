        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Edit Activation Form</h3>
                </div>
        ...
        <div class="nk-block">
            <div class="card card-bordered">
                <div class="card-inner">
                    <form action="{{ route('hostaboard.update', $hostaboard->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <select name="property_manager" id="property_manager" class="form-control select2" data-placeholder="Select Sales Manager" required>
                                    ...
                                    @foreach($propertyManagers as $manager)
                                        <option value="{{ $manager->id }}" {{ $manager->id == $hostaboard->property_manager ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="host_id" name="host_id" value="{{ $hostaboard->host_id }}" maxlength="10" placeholder="eg: KSA-103" required>
                                    @error('host_id')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="property_id" name="property_id" value="{{ $hostaboard->property_id }}" maxlength="10" placeholder="LP-XXX (e.g. LP-101) | Add 'H' for cohosted (e.g. LP-101H)" required>
                                    @error('property_id')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $hostaboard->title }}" placeholder="title" required>
                                    @error('title')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="owner_name" name="owner_name" value="{{ $hostaboard->owner_name }}" placeholder="eg: john" required>
                                    @error('owner_name')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="last_name" name="last_name" value="{{ $hostaboard->last_name }}" placeholder="eg: smith" required>
                                    @error('last_name')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel"
                                           ...
                                           value="{{ $hostaboard->host_number }}" required>
                                    @error('host_number')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ $hostaboard->date_of_birth }}" >
                                    @error('date_of_birth')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="host_bank_detail" name="host_bank_detail" value="{{ $hostaboard->host_bank_detail }}" required placeholder="Bank Account Title">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="bank_name" name="bank_name" required placeholder="Select Bank">
                                        ...
                                        <option value="Al Rajhi Bank" {{ $hostaboard->bank_name == 'Al Rajhi Bank' ? 'selected' : '' }}>Al Rajhi Bank</option>
                                        <option value="Albilad Bank" {{ $hostaboard->bank_name == 'Albilad Bank' ? 'selected' : '' }}>Albilad Bank</option>
                                        <option value="The Saudi National Bank" {{ $hostaboard->bank_name == 'The Saudi National Bank' ? 'selected' : '' }}>The Saudi National Bank</option>
                                        <option value="Bank AlJazira" {{ $hostaboard->bank_name == 'Bank AlJazira' ? 'selected' : '' }}>Bank AlJazira</option>
                                        <option value="Alinma Bank" {{ $hostaboard->bank_name == 'Alinma Bank' ? 'selected' : '' }}>Alinma Bank</option>
                                        <option value="Riyadh Bank" {{ $hostaboard->bank_name == 'Riyadh Bank' ? 'selected' : '' }}>Riyadh Bank</option>
                                        <option value="Banque Saudi Fransi" {{ $hostaboard->bank_name == 'Banque Saudi Fransi' ? 'selected' : '' }}>Banque Saudi Fransi</option>
                                        <option value="The Saudi Investment Bank" {{ $hostaboard->bank_name == 'The Saudi Investment Bank' ? 'selected' : '' }}>The Saudi Investment Bank</option>
                                        <option value="Saudi Awwal Bank (SAB)" {{ $hostaboard->bank_name == 'Saudi Awwal Bank (SAB)' ? 'selected' : '' }}>Saudi Awwal Bank (SAB)</option>
                                        <option value="Gulf International Bank (MEB)" {{ $hostaboard->bank_name == 'Gulf International Bank (MEB)' ? 'selected' : '' }}>Gulf International Bank (MEB)</option>
                                    </select>
                                    @error('bank_name')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="swift_code" name="swift_code" value="{{ $hostaboard->swift_code }}" required placeholder="Must be a valid SWIFT/BIC format">
                                    @error('swift_code')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="type" name="type" required placeholder="Select Property Type">
                                        ...
                                        <option value="Apartment" {{ $hostaboard->type == 'Apartment' ? 'selected' : '' }}>Apartment</option>
                                        <option value="Land" {{ $hostaboard->type == 'Land' ? 'selected' : '' }}>Land</option>
                                        <option value="Villa" {{ $hostaboard->type == 'Villa' ? 'selected' : '' }}>Villa</option>
                                        <option value="Floor" {{ $hostaboard->type == 'Floor' ? 'selected' : '' }}>Floor</option>
                                        <option value="Building" {{ $hostaboard->type == 'Building' ? 'selected' : '' }}>Building</option>
                                        <option value="Studio" {{ $hostaboard->type == 'Studio' ? 'selected' : '' }}>Studio</option>
                                         
                                        <option value="Tower" {{ $hostaboard->type == 'Tower' ? 'selected' : '' }}>Tower</option>
                                        <option value="Hotel" {{ $hostaboard->type == 'Hotel' ? 'selected' : '' }}>Hotel</option>
                                    </select>
                                    @error('type')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="unit_type" name="unit_type" required>
                                        ...
                                        <option value="1BR" {{ $hostaboard->unit_type == '1BR' ? 'selected' : '' }}>1BR</option>
                                        <option value="2BR" {{ $hostaboard->unit_type == '2BR' ? 'selected' : '' }}>2BR</option>
                                        <option value="3BR" {{ $hostaboard->unit_type == '3BR' ? 'selected' : '' }}>3BR</option>
                                        <option value="Studio" {{ $hostaboard->unit_type == 'Studio' ? 'selected' : '' }}>Studio</option>
                                        <option value="Chalet" {{ $hostaboard->unit_type == 'Chalet' ? 'selected' : '' }}>Chalet</option>
                                    </select>
                                    @error('unit_type')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="unit_number" name="unit_number" value="{{ $hostaboard->unit_number }}" maxlength="10" required placeholder="Unit Number">
                                    @error('unit_number')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="floor" name="floor" required>
                                        ...
                                        <option value="Basement" {{ $hostaboard->floor == 'Basement' ? 'selected' : '' }}>Basement</option>
                                        <option value="Ground Floor" {{ $hostaboard->floor == 'Ground Floor' ? 'selected' : '' }}>Ground Floor</option>
                                        <option value="First Floor" {{ $hostaboard->floor == 'First Floor' ? 'selected' : '' }}>First Floor</option>
                                        <option value="Second Floor" {{ $hostaboard->floor == 'Second Floor' ? 'selected' : '' }}>Second Floor</option>
                                        <option value="Third Floor" {{ $hostaboard->floor == 'Third Floor' ? 'selected' : '' }}>Third Floor</option>
                                        <option value="Fourth Floor" {{ $hostaboard->floor == 'Fourth Floor' ? 'selected' : '' }}>Fourth Floor</option>
                                        <option value="Fifth Floor" {{ $hostaboard->floor == 'Fifth Floor' ? 'selected' : '' }}>Fifth Floor</option>
                                        <option value="Sixth Floor" {{ $hostaboard->floor == 'Sixth Floor' ? 'selected' : '' }}>Sixth Floor</option>
                                        <option value="Seventh Floor" {{ $hostaboard->floor == 'Seventh Floor' ? 'selected' : '' }}>Seventh Floor</option>
                                        <option value="Eighth Floor" {{ $hostaboard->floor == 'Eighth Floor' ? 'selected' : '' }}>Eighth Floor</option>
                                        <option value="Ninth Floor" {{ $hostaboard->floor == 'Ninth Floor' ? 'selected' : '' }}>Ninth Floor</option>
                                        <option value="Tenth Floor" {{ $hostaboard->floor == 'Tenth Floor' ? 'selected' : '' }}>Tenth Floor</option>
                                        <option value="Eleventh Floor" {{ $hostaboard->floor == 'Eleventh Floor' ? 'selected' : '' }}>Eleventh Floor</option>
                                        <option value="Twelfth Floor" {{ $hostaboard->floor == 'Twelfth Floor' ? 'selected' : '' }}>Twelfth Floor</option>
                                        <option value="Thirteenth Floor" {{ $hostaboard->floor == 'Thirteenth Floor' ? 'selected' : '' }}>Thirteenth Floor</option>
                                        <option value="Fourteenth Floor" {{ $hostaboard->floor == 'Fourteenth Floor' ? 'selected' : '' }}>Fourteenth Floor</option>
                                        <option value="Fifteenth Floor" {{ $hostaboard->floor == 'Fifteenth Floor' ? 'selected' : '' }}>Fifteenth Floor</option>
                                        <option value="Sixteenth Floor" {{ $hostaboard->floor == 'Sixteenth Floor' ? 'selected' : '' }}>Sixteenth Floor</option>
                                        <option value="Seventeenth Floor" {{ $hostaboard->floor == 'Seventeenth Floor' ? 'selected' : '' }}>Seventeenth Floor</option>
                                        <option value="Eighteenth Floor" {{ $hostaboard->floor == 'Eighteenth Floor' ? 'selected' : '' }}>Eighteenth Floor</option>
                                        <option value="Nineteenth Floor" {{ $hostaboard->floor == 'Nineteenth Floor' ? 'selected' : '' }}>Nineteenth Floor</option>
                                        <option value="Twentieth Floor" {{ $hostaboard->floor == 'Twentieth Floor' ? 'selected' : '' }}>Twentieth Floor</option>
                                    </select>
                                    @error('floor')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="property_area" name="property_area" value="{{ $hostaboard->property_area }}" maxlength="10"  placeholder="Property Area">
                                    @error('property_area')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="property_services" name="property_services" value="{{ $hostaboard->property_services }}"  placeholder="Property Services">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="property_age" name="property_age" value="{{ $hostaboard->property_age }}" maxlength="10"  placeholder="Property Age">
                                    @error('property_age')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="room_number" name="room_number" value="{{ $hostaboard->room_number }}" maxlength="10"  placeholder="Room Number">
                                    @error('room_number')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="street" name="street" value="{{ $hostaboard->street }}" placeholder="Street Name / Number" required>
                                    @error('street')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
...
<div class="col-md-6">
    ...
    'Salahuddin', 'Shubra', 'Tuwaiq', 'Umm Al Hamam', 'Wadi Laban', 'Yarmuk','AL Qudus','AL Hamra'
            ...
            @foreach ($districts as $district)
                <option value="{{ $district }}" {{ old('district', $hostaboard->district) == $district ? 'selected' : '' }}>
                    {{ $district }}
                </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" id="city_name" name="city_name">
            ...
            <option value="Riyadh" {{ $hostaboard->city_name == 'Riyadh' ? 'selected' : '' }}>Riyadh</option>
            <option value="Jeddah" {{ $hostaboard->city_name == 'Jeddah' ? 'selected' : '' }}>Jeddah</option>
            <option value="Makkah" {{ $hostaboard->city_name == 'Makkah' ? 'selected' : '' }}>Makkah</option>
            <option value="Medinah" {{ $hostaboard->city_name == 'Medinah' ? 'selected' : '' }}>Medinah</option>
            <option value="Khobar" {{ $hostaboard->city_name == 'Khobar' ? 'selected' : '' }}>Khobar</option>
            <option value="Dammam" {{ $hostaboard->city_name == 'Dammam' ? 'selected' : '' }}>Dammam</option>
        </select>
        @error('city_name')
            <span class="invalid">{{ $message }}</span>
        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="property_address" name="property_address" placeholder="E.g RFYB3686, 3686 Muhammad Ali Junah, 7437, Al Yarmuk, Riyadh 13251, Saudi Arabia" required maxlength="250">{{ $hostaboard->property_address }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ $hostaboard->postal_code }}" maxlength="5" required placeholder="eg. 74200">
                                    @error('postal_code')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="building_Caretaker_name" name="building_Caretaker_name" value="{{ $hostaboard->building_Caretaker_name }}" placeholder="Building Caretaker Name">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel"
                                           ...
                                           value="{{ $hostaboard->building_Caretaker_Number }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="bedrooms" name="bedrooms" required placeholder="Select Bedrooms">
                                        ...
                                        <option value="1" {{ $hostaboard->bedrooms == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ $hostaboard->bedrooms == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ $hostaboard->bedrooms == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ $hostaboard->bedrooms == '4' ? 'selected' : '' }}>4</option>
                                    </select>    
                                    @error('bedrooms')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control select2" id="beds" name="beds" required>
            ...
            @for ($i = 1; $i <= 4; $i++)
                <option value="{{ $i }}" {{ (old('beds', $hostaboard->beds) == $i) ? 'selected' : '' }}>{{ $i }}</option>
            @endfor
        </select>
        @error('beds')
            <span class="invalid">{{ $message }}</span>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control select2 " id="bathrooms" name="bathrooms" required>
            ...
            @for ($i = 1; $i <= 4; $i++)
                <option value="{{ $i }}" {{ (old('bathrooms', $hostaboard->bathrooms) == $i) ? 'selected' : '' }}>{{ $i }}</option>
            @endfor
        </select>
        @error('bathrooms')
            <span class="invalid">{{ $message }}</span>
        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="living_room_yes" name="living_room" value="1"
                                                   {{ $hostaboard->living_room == '1' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="living_room_no" name="living_room" value="0"
                                                   {{ $hostaboard->living_room == '0' ? 'checked' : '' }} required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="kitchen_yes" name="kitchen" value="1"
                                                   {{ $hostaboard->kitchen == '1' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="kitchen_no" name="kitchen" value="0"
                                                   {{ $hostaboard->kitchen == '0' ? 'checked' : '' }} required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="outdoor_area_yes" name="outdoor_area" value="1"
                                                   {{ $hostaboard->outdoor_area == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="outdoor_area_no" name="outdoor_area" value="0"
                                                   {{ $hostaboard->outdoor_area == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="laundry_area_yes" name="laundry_area" value="1"
                                                   {{ $hostaboard->laundry_area == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" id="laundry_area_no" name="laundry_area" value="0"
                                                   {{ $hostaboard->laundry_area == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="be_listing_name" name="be_listing_name" value="{{ $hostaboard->be_listing_name }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="property_about" name="property_about">{{ $hostaboard->property_about }}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="discounts" name="discounts" value="{{ $hostaboard->discounts }}">
                                    @error('discounts')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="tax" name="tax" value="{{ $hostaboard->tax }}">
                                    @error('tax')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="door_locks_mechanism" name="door_locks_mechanism" required>
                                            <option value="" disabled>Select Door Lock Mechanism</option>
                                            <option value="Auto" {{ $hostaboard->door_locks_mechanism == 'Auto' ? 'selected' : '' }}>Auto</option>
                                            <option value="Manual" {{ $hostaboard->door_locks_mechanism == 'Manual' ? 'selected' : '' }}>Manual</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ $hostaboard->door_lock_code }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="wi_fi_password"
                                           name="wi_fi_password"
                                           value="{{ $hostaboard->wi_fi_password }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="existing_ota_links" name="existing_ota_links" placeholder="https://www.airbnb.com/rooms/1173067429189103741?guests=1&adults=1&s=67&unique_share_id=da6130c9-0bd8-44be-8c14-4fcf8325cb72 , https://gathern.co/view/87048">{{ $hostaboard->existing_ota_links }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url"
                                           ...
                                           value="{{ $hostaboard->property_google_map_link }}"
...
<div class="col-md-6 mt-5">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input"
               ...
               value="1"
               {{ old('is_photo_exists', $hostaboard->is_photo_exists) == '1' ? 'checked' : '' }}
               required>
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input"
               ...
               value="0"
               {{ old('is_photo_exists', $hostaboard->is_photo_exists) == '0' ? 'checked' : '' }}
               required>
...
<div class="col-md-6" id="property_images_container">
    <div class="form-group">
        ...
        <input type="url"
               ...
               value="{{ old('property_images_link', $hostaboard->property_images_link) }}">
        ...
        @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="cleaning_fee" name="cleaning_fee" required>
                                        <option value="" disabled>Select Cleaning Fee</option>
                                        @foreach([60, 90, 120, 150] as $fee)
                                            <option value="{{ $fee }}" {{ $hostaboard->cleaning_fee == $fee ? 'selected' : '' }}>{{ $fee }} SAR</option>
                                        @endforeach
                                    </select>
                                    @error('cleaning_fee')
                                        <span class="invalid">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
    <div class="form-group">
        <label class="form-label" for="contract_file">Contract File</label>
        @if(isset($hostaboard) && $hostaboard->contract_file)
            <div class="mb-2">
                <a href="{{ asset('storage/' . $hostaboard->contract_file) }}" target="_blank" class="btn btn-outline-primary">
                    View Current Contract File
                </a>
            </div>
        @endif
...
<div class="col-md-6">
    <div class="form-group">
        <label class="form-label" for="utiltiy_bills">Utility Bills</label>
        @if(isset($hostaboard) && $hostaboard->utiltiy_bills)
            <div class="mb-2">
                <a href="{{ asset('storage/' . $hostaboard->utiltiy_bills) }}" target="_blank" class="btn btn-outline-primary">
                    View Current Utility Bills
                </a>
            </div>
        @endif
        <input type="file" class="form-control" id="utiltiy_bills" name="utiltiy_bills" accept="application/pdf">
        @error('utiltiy_bills')
            <span class="invalid">{{ $message }}</span>
        @enderror
    </div>
...
<div class="col-md-6">
    <div class="form-group">
        <label class="form-label" for="licence_doc">Licence Doc</label>
        @if(isset($hostaboard) && $hostaboard->licence_doc)
            <div class="mb-2">
                <a href="{{ asset('storage/' . $hostaboard->licence_doc) }}" target="_blank" class="btn btn-outline-primary">
                    View Current Licence Doc
                </a>
            </div>
        @endif
        <input type="file" class="form-control" id="licence_doc" name="licence_doc" accept="application/pdf">
        @error('licence_doc')
            <span class="invalid">{{ $message }}</span>
        @enderror
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="ownership_document">Ownership Documents</label>
                                    @if(isset($hostaboard) && $hostaboard->ownership_documents->isNotEmpty())
                                        <div class="mb-2">
                                            @foreach($hostaboard->ownership_documents as $document)
                                                <div class="mb-1">
                                                    <a href="{{ asset('storage/' . $document->document_path) }}" target="_blank" class="btn btn-outline-primary">
                                                        View Document {{ $loop->iteration }}
                                                    </a>
                                                    <i class="fa fa-trash" style="margin-left:8px; cursor:pointer;" onclick="deleteownershipDocument({{ $document->id }})"></i>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                                    <input type="file" class="form-control" id="ownership_documents" name="ownership_documents[]" multiple>
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="owner_document">Owner National ID/Iqama Picture/Photocopy (Front & Back)</label>
                                    @if(isset($hostaboard) && $hostaboard->owner_documents->isNotEmpty())
                                        <div class="mb-2">
                                            @foreach($hostaboard->owner_documents as $document)
                                                <div class="mb-1">
                                                    <a href="{{ asset('storage/' . $document->document_path) }}" target="_blank" class="btn btn-outline-primary">
                                                        View Document {{ $loop->iteration }}
                                                    </a>
                                                    <i class="fa fa-trash" style="margin-left:8px; cursor:pointer;" onclick="deleteDocument({{ $document->id }})"></i>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                                    <input type="file" class="form-control" id="owner_document" name="owner_document[]" multiple>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="spl_national_address">SPL National Address</label>
                                    @if(isset($hostaboard) && $hostaboard->national_address_document)
                                        <div class="mb-2">
                                            <a href="{{ asset('storage/' . $hostaboard->national_address_document) }}" target="_blank" class="btn btn-outline-primary">
                                                View Current SPL National Address
                                            </a>
                                        </div>
                                    @endif
                                    <input type="file" class="form-control" id="spl_national_address" name="spl_national_address" accept="application/pdf">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="host_rental_lease" name="host_rental_lease" value="{{ $hostaboard->host_rental_lease }}" required>
                            ...
                            <div class="col-md-3 mt-5">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           ...
                                           id="allow_pets_yes"
                                           value="1"
                                           {{ $hostaboard->is_allow_pets == '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           ...
                                           id="allow_pets_no"
                                           value="0"
                                           {{ $hostaboard->is_allow_pets == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mt-5">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           ...
                                           id="self_checkin_yes"
                                           value="1"
                                           {{ $hostaboard->is_self_check_in == '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           ...
                                           id="self_checkin_no"
                                           value="0"
                                           {{ $hostaboard->is_self_check_in == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="block_dates_via_host_app" name="block_dates_via_host_app">
                                        <option value="" disabled>Select Block Dates via Host App</option>
                                        <option value="1" {{ $hostaboard->block_dates_via_host_app == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->block_dates_via_host_app == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="ota_charges_on_direct_booking" name="ota_charges_on_direct_booking">
                                        <option value="" disabled>Select OTA Charges on Direct Booking</option>
                                        <option value="1" {{ $hostaboard->ota_charges_on_direct_booking == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->ota_charges_on_direct_booking == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label" for="cleaning_fee_on_direct_booking">Cleaning Fee on Direct Booking</label>
                                    <select class="form-control select2" id="cleaning_fee_on_direct_booking" name="cleaning_fee_on_direct_booking">
                                        <option value="" disabled>Select Cleaning Fee on Direct Booking</option>
                                        <option value="1" {{ $hostaboard->cleaning_fee_on_direct_booking == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->cleaning_fee_on_direct_booking == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="fixed_cleaning_fee" name="fixed_cleaning_fee">
                                        <option value="" disabled>Select Fixed Cleaning Fee</option>
                                        <option value="1" {{ $hostaboard->fixed_cleaning_fee == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->fixed_cleaning_fee == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="fixed_cleaning_fee_amount" name="fixed_cleaning_fee_amount" placeholder="Enter Fixed Cleaning Fee Amount" value="{{ $hostaboard->fixed_cleaning_fee_amount }}">
                            ...
                            <div class="col-md-3">
                                <label class="form-label d-block">Deep Cleaning Required?</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           type="radio"
                                           ...
                                           value="1"
                                           {{ $hostaboard->deep_cleaning_required == '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"
                                           ...
                                           value="0"
                                           {{ $hostaboard->deep_cleaning_required == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label" for="co_hosting_account">Co-Hosting Account</label>
                                    <select class="form-control select2" id="co_hosting_account" name="co_hosting_account">
                                        <option value="" disabled {{ $hostaboard->co_hosting_account === null ? 'selected' : '' }}>Select Co Hosting Account</option>
                                        <option value="1" {{ $hostaboard->co_hosting_account == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->co_hosting_account == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="airbnb_password" name="airbnb_password"
                                           ...
                                           value="{{ $hostaboard->airbnb_password }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label" for="length_type">Length Type</label>
                                    <select class="form-control select2" id="length_type" name="length_type">
                                        <option value="" disabled>Select Length Type</option>
                                        <option value="Short Term" {{ $hostaboard->length_type == 'Short Term' ? 'selected' : '' }}>Short Term</option>
                                        <option value="Long Term" {{ $hostaboard->length_type == 'Long Term' ? 'selected' : '' }}>Long Term</option>
                                    </select>
                                    @error('length_type')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
    ...
    <div class="form-group">
        ...
        @if(isset($hostaboard) && $hostaboard->lenght_type_document)
            <div class="mb-2">
                <a href="{{ asset('storage/' . $hostaboard->lenght_type_document) }}" target="_blank" class="btn btn-outline-primary">
                    View Current Length Type Document
                </a>
            </div>
        @endif
        ...
        @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="min_days_for_ltr" name="min_days_for_ltr" placeholder="Enter Min Days Ltr" value="{{ $hostaboard->min_days_for_ltr }}">
...
<div class="col-md-6">
    <div class="form-group">
       <label class="form-label" for="type_of_ownership_document">
           Type of Ownership Document 
           <span class="text-danger d-none" id="type_of_ownership_document_asterisk">*</span>
       </label>
        <select class="form-control select2" id="type_of_ownership_document" name="type_of_ownership_document[]" multiple>
            <option value="Paper Title Deed" {{ in_array('Paper Title Deed', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Paper Title Deed</option>
            <option value="Electronic Lease Contract" {{ in_array('Electronic Lease Contract', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Electronic Lease Contract</option>
            <option value="Electronic Title Deed" {{ in_array('Electronic Title Deed', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Electronic Title Deed</option>
            <option value="Commercial Registration Title" {{ in_array('Commercial Registration Title', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Commercial Registration Title</option>
            <option value="Court Ruling of Ownership (Istihkam)" {{ in_array('Court Ruling of Ownership (Istihkam)', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Court Ruling of Ownership (Istihkam)</option>
            <option value="Inheritance Title" {{ in_array('Inheritance Title', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Inheritance Title</option>
            <option value="Funding Title" {{ in_array('Funding Title', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Funding Title</option>
            <option value="Off-Plan (WAFI) Contract" {{ in_array('Off-Plan (WAFI) Contract', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Off-Plan (WAFI) Contract</option>
            <option value="Contractual Status on Ejar Platform" {{ in_array('Contractual Status on Ejar Platform', $hostaboard->type_of_ownership_document) ? 'selected' : '' }}>Contractual Status on Ejar Platform</option>
        </select>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        @if(isset($hostaboard) && $hostaboard->existing_property_obligations)
            <div class="mb-2">
                <a href="{{ asset('storage/' . $hostaboard->existing_property_obligations) }}" target="_blank" class="btn btn-outline-primary">
                    View Existing Property Obligations (Insurance)
                </a>
            </div>
        @endif
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="text" 
               ...
               value="{{ old('ownership_document_number_and_type', $hostaboard->ownership_document_number_and_type ?? '') }}" 
               pattern="[A-Za-z0-9\s\-\/]+" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="services" name="services">
                                        ...
                                        <option value="Guest management only" {{ $hostaboard->services == 'Guest management only' ? 'selected' : '' }}>Guest management only</option>
                                        <option value="Revene Management Only" {{ $hostaboard->services == 'Revene Management Only' ? 'selected' : '' }}>Revene Management Only</option>
                                        <option value="Cleaning & Laundry Services Only" {{ $hostaboard->services == 'Cleaning & Laundry Services Only' ? 'selected' : '' }}>Cleaning & Laundry Services Only</option>
                                    </select>
                                    @error('services')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="livedin_share_after_discount" name="livedin_share_after_discount">
                                        <option value="" disabled>Select LivedIn Share After Discount</option>
                                        <option value="1" {{ $hostaboard->livedin_share_after_discount == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $hostaboard->livedin_share_after_discount == '0' ? 'selected' : '' }}>No</option>
                                    </select>
...
<div class="col-md-3">
    ...
    <label class="form-label" for="share_percentage">LivedIn Share Percentage <span class="text-danger">*</span></label>
         <input type="number" class="form-control" id="share_percentage" name="share_percentage" placeholder="Enter Percentage" value="{{$hostaboard->share_percentage }}" required>
...
<div class="col-md-3">
    ...
    <label class="form-label" for="host_exclusivity">Host Exclusivity <span class="text-danger">*</span></label>
        <select class="form-control select2" id="host_exclusivity" name="host_exclusivity" required>
            ...
            <option value="Exclusive" {{ $hostaboard->host_exclusivity == 'Exclusive' ? 'selected' : '' }}>Exclusive</option>
            <option value="Non Exclusive" {{ $hostaboard->host_exclusivity == 'Non Exclusive' ? 'selected' : '' }}>Non Exclusive</option>
        </select>
...
<div class="col-md-3">
    ...
    <label class="form-label" for="cleaning_done_by_livedin">Cleaning Done By LivedIn <span class="text-danger">*</span></label>
        <select class="form-control select2" id="cleaning_done_by_livedin" name="cleaning_done_by_livedin" required>
            ...
            <option value="1" {{ $hostaboard->cleaning_done_by_livedin == '1' ? 'selected' : '' }}>Yes</option>
            <option value="0" {{ $hostaboard->cleaning_done_by_livedin == '0' ? 'selected' : '' }}>No</option>
        </select>
        ...
        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="building_type" name="building_type">
                                        <option value="" disabled>Select Building Type</option>
                                        <option value="Apartment in Villa" {{ $hostaboard->building_type == 'Apartment in Villa' ? 'selected' : '' }}>Apartment in Villa</option>
                                        <option value="Apartment in Building" {{ $hostaboard->building_type == 'Apartment in Building' ? 'selected' : '' }}>Apartment in Building</option>
                                    </select>
                                    @error('building_type')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="floor_number" name="floor_number">
                                        <option value="" disabled>Select Floor</option>
                                        @for ($i = 1; $i <= 50; $i++)
                                            <option value="{{ $i }}" {{ $hostaboard->floor_number == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @error('floor_number')
                                        <span class="invalid">{{ $message }}</span>
    ...
    <label class="form-label" for="building_number">Building Number 
         ...
         <input type="text" class="form-control" id="building_number" name="building_number" placeholder="Enter Building Number" value="{{$hostaboard->building_number }}" >
...
<div class="col-md-3">
    ...
    <span class="text-danger d-none" id="additional_number_asterisk">*</span>
         ...
         <input type="text" class="form-control" id="additional_number" name="additional_number" placeholder="Enter Additional Number" value="{{$hostaboard->additional_number }}" >
    ...
    'Free Parking Premises'
                    ...
                    $selectedAmenities = old('amenities', explode(',', $hostaboard->amenities));
                @endphp
                                        @foreach($amenities as $amenity)
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="amenity_{{ $loop->index }}" name="amenities[]" value="{{ $amenity }}" @if(in_array($amenity, $selectedAmenities)) checked @endif>
