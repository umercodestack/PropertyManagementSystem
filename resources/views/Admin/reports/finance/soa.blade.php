                    ...
                    {{-- {{ dd($item) }} --}}
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('reports.finance.soa.print') }}?user_id={{ $item->user_id }}&daterange={{ $item->booking_dates }}&listings={{ $item->listings }}" class="btn btn-primary btn-sm" >
