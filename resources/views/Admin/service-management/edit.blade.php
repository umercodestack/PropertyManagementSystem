        ...
        <div class="nk-block">
            <div class="card card-bordered">
                <div class="card-inner">
                    <form action="{{route('service-management.update', $service->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row gy-4">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" name="service_category_id" id="service_category_id" data-placeholder="Select Service Category">
                                            ...
                                            @foreach($serviceCategory as $items)
                                                <option value="{{$items->id}}" {{$service->service_category_id === $items->id ? 'selected' : ''}}>{{$items->category_name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{$service->title}}" placeholder="Service Title">
                                    @error('title')
                                    <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Service Description">{{$service->description}}</textarea>
