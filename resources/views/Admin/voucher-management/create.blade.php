        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Create Voucher</h3>
        ...
        <div class="nk-block">
            <div class="card card-bordered">
                <div class="card-inner">
                    <form action="{{route('voucher-management.store')}}" method="POST" onsubmit="return syncDropdownSelection();">
                        @csrf
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="voucher_code" name="voucher_code" placeholder="Voucher Name" value="{{ old('voucher_code') }}" autocomplete="off" required onkeydown="return event.key !== ' '">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="voucher_start_date" name="voucher_start_date" placeholder="Voucher Start Date" value="{{ old('voucher_start_date') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="voucher_end_date" name="voucher_end_date" placeholder="Voucher End Date" value="{{ old('voucher_end_date') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="discount" name="discount" placeholder="Discount" value="{{ old('discount') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" placeholder="Max Discount Amount" value="{{ old('max_discount_amount') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id=">min_order_amount" name="min_order_amount" placeholder="Minimum Order Amount" value="{{ old('min_order_amount') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id=">min_number_nights" name="min_number_nights" placeholder="Minimum Number of Nights" value="{{ old('min_number_nights') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" name="discount_applied_on" id="discount_applied_on" data-placeholder="Select an option" required>
                                            <option value="">Please select an option</option>
                                            <option value="per_night_value">Per Night Value</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id=">voucher_usage_limit" name="voucher_usage_limit" placeholder="Voucher Usage Limit" value="{{ old('voucher_usage_limit') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id=">max_uses_per_guest" name="max_uses_per_guest" placeholder="Maximum number of uses per guest" value="{{ old('max_uses_per_guest') }}" autocomplete="off" required>
                                    @error('name')
                                        <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
  ...
  function renderOptions(filter = '') {
    ...
    options
      ...
      .forEach(opt => {
        ...
        // Disable others if 'Select All' is selected
