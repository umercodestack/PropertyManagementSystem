        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Create Task Invoice</h3>
        ...
        <div class="nk-block">
            <div class="card card-bordered">
                <div class="card-inner">
                    <form action="{{route('task-invoice-management.store')}}" method="POST">
                        @csrf
                        <div class="row gy-4">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" name="task_id" id="task_id" data-placeholder="Select Task">
                                            ...
                                            @foreach($task as $items)
                                                <option value="{{$items->id}}">{{$items->task_title}}</option>
                                            @endforeach
                                        </select>
                                        @error('task_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" placeholder="Time Duration">
                                    @error('amount')
                                    <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="currency" name="currency" placeholder="Time Currency">
                                    @error('currency')
                                    <span id="fva-full-name-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
