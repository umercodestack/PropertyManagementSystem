               ...
               <tbody>
                    @foreach ($cleanings as $key => $item)
                        ...
                        <tr>
                            ...
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ isset( $item['cleaner_name']) ? $item['cleaner_name'] . " " .$item['cleaner_surname'] : "N/A"}}</td>

                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ isset($item['guest_name']) ? $item['guest_name'] . " ".  $item['guest_surname'] :""  }}</td>
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ isset($item['guest_phone']) ? $item['guest_phone'] : '' }}</td>
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ $item['key_code'] }}</td>
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ $item['checkin'] }}</td>
                            ...
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
                                {{ isset($item['status'])? $item['status'] : "pending" }}
                            </td>
                            <td style="{{ $item['has_checkin'] == 1 ? 'background: green; color: white' : '' }}">
