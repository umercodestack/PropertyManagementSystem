    ...
    <div class="nk-split nk-split-page nk-split-lg">
        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-block-des">
                            <p>Access the Livedin panel using your email and passcode.</p>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <form action="{{ route('login.post') }}" class="form-validate is-alter" method="POST">
                    @csrf
            ...
            <div class="nk-block nk-auth-footer">
                ...
                <div class="mt-3">
                    <p>&copy; 2025 Livedin. All Rights Reserved.</p>
                </div>
            </div><!-- .nk-block -->
        ...
        <div class="nk-split-content nk-split-stretch bg-lighter d-flex toggle-break-lg toggle-slide toggle-slide-right"
            ...
            {{-- <img src="{{ asset('assets/images/login-cover.jpg') }}" height="" style="height:100%;width:100%" /> --}}
        </div><!-- .nk-split-content -->
    </div><!-- .nk-split -->
@endsection