...
class AdrExportAirBnb implements FromCollection, WithTitle
{
    protected $data;
        ...
        foreach ($listings as $key => $items) {
            ...
            foreach ($period as $index => $item) {
                ...
                $otaBookingData = BookingOtasDetails::where('listing_id', $items->listing_id)
                    ...
                    ->whereJsonContains('booking_otas_json_details->attributes->ota_name', 'AirBNB')
